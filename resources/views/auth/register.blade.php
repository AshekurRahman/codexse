<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" data-ajax-form>
        ...
        <div>
            ...
            <x-text-input id="name" type="text" name="name" :value="old('name')" autofocus autocomplete="name" placeholder="John Doe" data-validate="required|min:2" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" type="email" name="email" :value="old('email')" autocomplete="username" placeholder="you@example.com" data-validate="required|email" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" type="password" name="password" autocomplete="new-password" placeholder="Create a strong password" data-validate="required|min:8" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" type="password" name="password_confirmation" autocomplete="new-password" placeholder="Confirm your password" data-validate="required|match:password" />
