<x-layouts.app
    :title="'Posts tagged with \"' . $tag . '\" - Blog - ' . config('app.name')"
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
            ...
            <nav class="mb-6">
                <ol class="flex items-center gap-2 text-sm text-surface-500 dark:text-surface-400">
                    ...
                    <li><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></li>
                    <li class="text-surface-900 dark:text-white font-medium">Tag: {{ $tag }}</li>
                </ol>
            </nav>

            <div class="max-w-2xl">
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-accent-100 dark:bg-accent-900/50 text-accent-700 dark:text-accent-300 rounded-full mb-6">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                    </svg>
                    <span class="font-semibold">Tag</span>
                </div>
                <h1 class="text-4xl md:text-5xl font-bold text-surface-900 dark:text-white">
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-accent-600">#</span>{{ $tag }}
                </h1>
                <p class="mt-6 text-lg text-surface-500 dark:text-surface-400">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="text-center py-20 bg-surface-50 dark:bg-surface-800/50 rounded-3xl">
                    ...
                    <h3 class="text-xl font-bold text-surface-900 dark:text-white mb-2">No articles with this tag</h3>
            ...
            <aside class="lg:col-span-1 space-y-8">
                ...
                <div class="bg-white dark:bg-surface-800 rounded-2xl p-6 shadow-lg shadow-surface-200/50 dark:shadow-none border border-surface-100 dark:border-surface-700">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('blog.tag', $tagName) }}" class="px-4 py-2 text-sm font-medium rounded-full transition-colors {{ $tagName === $tag ? 'bg-primary-600 text-white' : 'bg-surface-100 dark:bg-surface-700 text-surface-700 dark:text-surface-300 hover:bg-primary-100 hover:text-primary-700 dark:hover:bg-primary-900 dark:hover:text-primary-300' }}">
                            #{{ $tagName }}
                        </a>
                        @endforeach
                    </div>
                ...
                <!-- Back to Blog -->
                <div class="bg-gradient-to-br from-accent-600 to-accent-700 rounded-2xl p-6 text-white">
                    <h3 class="text-lg font-bold mb-2">Explore More</h3>
                    <p class="text-accent-100 text-sm mb-4">Discover more articles and tags.</p>
                    <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-white text-accent-600 font-semibold rounded-xl hover:bg-accent-50 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                        </svg>
                        All Articles
