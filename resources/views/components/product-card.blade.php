    ...
    <div class="p-5">
        ...
        <div class="flex items-center justify-between pt-4 border-t border-surface-100 dark:border-surface-700">
            ...
            <button
                ...
                class="text-white text-sm font-medium px-4 py-2.5 rounded-xl transition-all flex items-center gap-2"
                :class="inCart ? 'bg-success-500' : 'bg-primary-600 hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-500/25'"
            >
