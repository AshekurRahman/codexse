    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 * Database-only backup by default for security and performance.
                 * Add paths here if you need to backup specific files/directories.
                 */
                'include' => [
                    // Database-only backup for security - no source files
                    // Uncomment below if you need to backup uploaded files:
                    // storage_path('app/public'),
                ],

                /*
                 * These directories and files will be excluded from the backup.
                 * Includes sensitive files and directories that should never be backed up.
                 */
                'exclude' => [
                    // Large directories
                    base_path('vendor'),
                    ...
                    // Sensitive files that should never be in backups
                    base_path('.env'),
